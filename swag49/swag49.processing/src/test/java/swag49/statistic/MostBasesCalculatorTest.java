...
public class MostBasesCalculatorTest {
    @PersistenceContext (unitName = "swag49.map")
    private EntityManager em;

    @Autowired
    @Qualifier("mostBasesCalculator")
    ...
    public void execute_statisticNotYetPersisted_shouldPersistCorrectEntries() {
        ...
        query.setParameter("name", MostBasesCalculator.NAME);
        ...
        assertThat(entries[0].getPlayer().getId(), is(5L));
        assertThat(entries[0].getScore(), is(2));

        assertThat(entries[1].getRanking(), is(2));
        assertThat(entries[1].getPlayer().getId(), is(1L));
        assertThat(entries[1].getScore(), is(1));

        assertThat(entries[2].getRanking(), is(3));
        assertThat(entries[2].getPlayer().getId(), is(2L));
        assertThat(entries[2].getScore(), is(1));

        assertThat(entries[3].getRanking(), is(4));
        assertThat(entries[3].getPlayer().getId(), is(3L));
        assertThat(entries[3].getScore(), is(1));
    ...
    public void execute_statisticAlreadyPersisted_shouldPersistCorrectEntries() {
        ...
        statistic.setName(MostBasesCalculator.NAME);
