        ...
        <c:forEach items="${buildings}" var="building">
            <tr>
                ...
                <td><a class="contentLink"
                       href="build.html?buildingTypeId=${building.id}&baseId=${baseId}&position=${position}"><img
                        src="${resourcePath}<spring:theme code='theme.image.buildings.build'/>" alt="Build"></a></td>
            </tr>
        </c:forEach>
    </table>
</c:if>